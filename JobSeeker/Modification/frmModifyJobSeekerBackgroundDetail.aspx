...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table align="center" border="0" cellpadding="0" cellspacing="0" 
        style="width: 643px; height: 554px;">
        ...
        <tr style="font-size: 12pt">
            <td align="left" colspan="1" 
                style="font-size: 12pt; color: #006600; font-weight: bold; width: 180px;">
            ...
            <td align="left" colspan="2" style="width: 417px">
        ...
        <tr style="font-size: 12pt">
            <td align="left" colspan="1" 
                style="font-size: 12pt; color: #ffffff; width: 180px;">
        ...
        <tr style="font-size: 12pt; color: #ffcc00">
            ...
            <td align="left" colspan="2" style="width: 417px">
                <asp:ListBox ID="lstUniversity" runat="server" AutoPostBack="True" Height="59px"
                    ...
                    <asp:ListItem>NIIT University</asp:ListItem>
                    <asp:ListItem>JNU</asp:ListItem>
                ...
                <asp:TextBox ID="txtUniversity" runat="server" ReadOnly="True" Width="142px" 
                    ontextchanged="txtUniversity_TextChanged"></asp:TextBox><br />
        ...
        <tr style="font-size: 12pt">
            <td align="left" colspan="1" 
                style="font-size: 12pt; color: #ffffff; height: 22px; width: 180px;">
            ...
            <td align="left" colspan="1" style="font-size: 12pt; width: 33px; color: #ffffff; height: 22px;">
                <span style="color: #ff0000; font-weight: bold;">*</span></td>
            <td align="left" colspan="2" style="height: 22px; width: 417px;">
