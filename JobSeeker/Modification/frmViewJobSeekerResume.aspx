...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
            <td align="center" colspan="2" style="font-weight: bold; font-size: 14pt; color: #006600;
        ...
        <tr>
            <td align="center" colspan="2" style="font-weight: bold; color: #006600">
                OR</td>
        </tr>
        <tr>
            ...
            <td align="left">
                <asp:HyperLink ID="hypResume" runat="server" ForeColor="DimGray" Width="393px" Font-Bold="True">[hypResume]</asp:HyperLink>
                 <br />
                <br />
                <br />
                <br />
